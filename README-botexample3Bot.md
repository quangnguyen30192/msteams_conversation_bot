...
3. Give the bot a handle (ex: `botexample3Bot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://botexample3.azurewebsites.net/api/messages`
